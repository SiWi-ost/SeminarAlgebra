...
Im vorangegangenen Kapitel waren wir erfolgreich darin, eine Stammfunktion
einer rationale Funktionen zu finden.
Die Frage nach einer Stammfunktion von Funktionen wie den
Wurzelfunktionen, den trigonometrischen Funktionen oder einer Funktion
...
Stammfunktion?
Die Antwort gibt das \emph{Prinzip von Liouville}, welches in
Abschnitt~\ref{buch:intalg:section:liouville} vorgestellt wird.
...
bildet dieser Algorithmus die Basis der symbolischen Integrationsfunktion
