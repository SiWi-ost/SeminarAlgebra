...
Bei der Berechnung von Wegintegralen haben wir gelernt, dass es
dabei vor allem auf die Pole ankommt.
Im Falle eines rationalen Integranden $f(z)$ geht es also um die 
Nullstellen des Nenners.
Da das Integral linear ist, ist es naheliegend zu versuchen,
die rationale Funktion $f(z)$ in einzelne Summanden zu zerlegen,
welche jeweils nur eine einzige Nullstelle im Nenner haben.
Dies leistet die Partialbruchzerlegung, die in diesem Abschnitt
studiert und noch etwas verfeinert werden soll.
...
\]
aufgeteilt werden.
Das Polynom $a(z)$ ist holomorph in ganz $\mathbb{C}$ und trägt
...
$(z- a)^n$ immer als eine Summe von Termen der Form $A_k/(z- a)^{n-k}$
...
\end{align*}
Durch Division durch $u(z)^n$ kann jetzt wieder eine Darstellung
\begin{align*}
f(z)
&=
\frac{p(z)}{u(z)^n}
...
Auch $u_k(z)$ muss nicht irreduzibel sein.
...
\begin{array}{rcrcrcrcrcr}
  A^1_1 & &        &+&  A^2_1 & &       & &        &=&  0\phantom{.}\\
 2A^1_1 &+&  A^1_2 & &        &+& A^2_2 & &        &=&  0\phantom{.}\\
        & & 3A^1_2 &-& 2A^2_1 &-& A^2_2 &+&  A^2_3 &=&  1\phantom{.}\\
-2A^1_1 &+& 3A^1_2 & &        &-& A^2_2 &-& 2A^2_3 &=&  0\phantom{.}\\
...
Dank der Partialbruchzerlegung zerfällt der Integrand nach
\eqref{buch:analytisch:rational:partial:eqn:ansatz}
in Summanden der Form
...
A(z-\alpha)^{-l}.
\]
Die Stammfunktion eines solchen Terms ist
\begin{equation}
